		...
		$(function() {
			...
			$('#btnDeleteWish').on('click', function() {
				...
				$.ajax({
					method : 'get',
					url : 'deleteWish',
					data : "wishtable="+0+"&identificationnum="+wishnum+"&useremail=${useremail}",
					success: function(resp) {
						if(resp == "success") {
								location.href = "particularList?currentPage=${navi.currentPage - navi.PAGE_PER_GROUP}&useremail=${useremail}&wishtable=0&distinguishNum=1";
						}else {
							alert("찜한 목록 삭제 실패");
						}
					}
