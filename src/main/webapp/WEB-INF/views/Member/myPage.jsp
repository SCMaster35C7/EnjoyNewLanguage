...
<body>
   <header>
      ...
      <nav class="nav-extended">
        <div class="nav-wrapper">
          ...
          <a href="#" data-target="small-finishedNavi"  class="sidenav-trigger"><i class="material-icons">menu</i></a>
   ...
   <!-- 창 축소시 사이드 nav -->
   <ul class="sidenav" id="small-finishedNavi">
      <li>
                           ...
                           <c:forEach var="f" items="${finished}">
                              <tr>
                                 ...
                                 <td><a href="TryRetake?videoNum=${f.videoNum}"
                                    class="waves-effect waves-light btn right">再試驗</a></td>
                              </tr>
                           </c:forEach>
                        </c:if>
