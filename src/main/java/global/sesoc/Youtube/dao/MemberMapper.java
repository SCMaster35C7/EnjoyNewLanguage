...
public interface MemberMapper {
   ...
   public Integer checkChallengeCount(String useremail);          // x/0을 방지하기 위한 분모체크용
   ...
   public int getTotalCountFromFinished(String useremail);                     // 완료한 영상 총 개수
   public int getTotalCountFromUnfinished(String useremail);                  // 미완료한 영상 총 개수
   
   public List<Video> selectFinishedVideo(String useremail, RowBounds rbs);
   public List<Video> selectUnfinishedVideo(String useremail, RowBounds rbs);
}