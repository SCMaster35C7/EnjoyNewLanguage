...
public interface InvestigationMapper {
	...
	public Investigation existVideo(String url);										// 자막 요청 게시글 영상 중복 확인
	public int deleteInvUseURL(String url);												// url을 이용한 자막 요청 게시글 삭제 
	...
	public InvSubtitle selectOneFromSubUseNum(int subtitleNum);							// 자막 식별코드를 이용한 검색
}
